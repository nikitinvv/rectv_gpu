...
ext = Extension('_rectv', 
                sources=['src/rectv.cu', 'src/radonusfft.cu', 'src/rectv_wrap.cpp'],
...
if find_in_path('swig', os.environ['PATH']):
    subprocess.check_call('swig -python -c++ -o src/rectv_wrap.cpp src/rectv.i', shell=True)
else:
